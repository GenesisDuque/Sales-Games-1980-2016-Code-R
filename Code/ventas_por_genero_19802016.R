...
quantity_gender = sales_quantity_videogames_from_80_to_16$Quantity
type_gender = sales_quantity_videogames_from_80_to_16$Gender

#conversión a porcentaje
Porcentaje_gender = round(quantity_gender*100 / 16448)
...
#barplot
barplot(quantity_gender, col = brewer.pal(n=12, name="Paired"), names.arg =type_gender, main="Videosjuegos por género 1980-2016")
...
lines(x, Analisis_de_genero_VideoGames_Sales_1980_2016$JP_sales, col=3, type="l")
...
coef_na_80_16 = sd_na_80_16 / mean_na_80_16

#median
median_na_80_16 = median(dataset_sales_games_1980_2016_NA$gender_number)
...
#calculamos correlación de Pearson
coef_eu_80_16 = sd_eu_80_16 / mean_eu_80_16

#median
median_eu_80_16 = median(dataset_sales_games_1980_2016_EU$gender_number)
...
#calculamos correlación de Pearson
coef_jp_80_16 = sd_jp_80_16 / mean_jp_80_16

#median
median_jp_80_16 = median(dataset_sales_games_1980_2016_JP$gender_number)
...
#calculamos correlación de Pearson
coef_others_80_16 = sd_others_80_16 / mean_others_80_16  
...
#calculamos correlación de Pearson
coef_others_80_89 = sd_others_80_89 / mean_others_80_89
...
#calculamos la desviación típica
sd_na_80_89 = sd(dataset_gender_games_80_89_NA$Genre)

#calculamos correlación de Pearson
coef_na_80_89 = sd_na_80_89 / mean_na_80_89
...
#calculamos la desviación típica
sd_eu_80_89 = sd(dataset_gender_games_80_89_EU$code_gender)

#calculamos correlación de Pearson
coef_eu_80_89 = sd_eu_80_89 / mean_eu_80_89
...
#calculamos correlación de Pearson
coef_jp_80_89 = sd_jp_80_89 / mean_jp_80_89
...
#calculamos correlación de Pearson
coef_na_90_99 = sd_na_90_99 / mean_na_90_99
...
#calculamos correlación de Pearson
coef_eu_90_99 = sd_eu_90_99 / mean_eu_90_99
...
#calculamos correlación de Pearson
coef_jp_90_99 = sd_jp_90_99 / mean_jp_90_99
...
#calculamos correlación de Pearson
coef_ot_90_99 = sd_ot_90_99 / mean_ot_90_99


hist(dataset_gender_games_90_99_Others$code_gender, main="Género others del 90 al 99",ylab="Frecuencia", xlab="Género")
...
#calculamos correlación de Pearson
coef_na_00_09 = sd_na_00_09 / mean_na_00_09
...
#calculamos correlación de Pearson
coef_eu_00_09 = sd_eu_00_09 / mean_eu_00_09
...
#calculamos correlación de Pearson
coef_jp_00_09 = sd_jp_00_09 / mean_jp_00_09
...
#calculamos correlación de Pearson
coef_ot_00_09 = sd_ot_00_09 / mean_ot_00_09
...
#calculamos correlación de Pearson
coef_na_10_16 = sd_na_10_16 / mean_na_10_16
...
#calculamos correlación de Pearson
coef_eu_10_16 = sd_eu_10_16 / mean_eu_10_16
...
#calculamos correlación de Pearson
coef_jp_10_16 = sd_jp_10_16 / mean_jp_10_16
...
#calculamos correlación de Pearson
coef_ot_10_16 = sd_ot_10_16 / mean_ot_10_16
